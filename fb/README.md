...
__Fun fact 2__: John Carmack was looking for a name for the file
...
If you follow the above instruction, your fuzz target will be able to
...
`NULL`.  ![The html report interface](doc_imgs/html_report.png)
